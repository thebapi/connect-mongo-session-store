...
FilterApi.prototype.correctFilters = function (filters) {
  ...
  filters.forEach(function (filterItem) {
    ...
    var operator = trim(filterItem.operator.toString()).toLowerCase();
    var condition = trim(filterItem.condition.toString()).toLowerCase();
